...
const RequestClient_1 = __importDefault(require("twilio/lib/base/RequestClient")); /* jshint ignore:line */
const os = require("os"); /* jshint ignore:line */
const url = require("url"); /* jshint ignore:line */
const moduleInfo = require("twilio/package.json"); /* jshint ignore:line */
const util = require("util"); /* jshint ignore:line */
const RestException = require("twilio/lib/base/RestException"); /* jshint ignore:line */
var Twilio;
(function (Twilio) {
    /* jshint ignore:start */
    /**
